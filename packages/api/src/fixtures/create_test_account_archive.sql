...
(2, 4, 'access.role.owner', 0, 'type.account.standard', 'status.generic.ok'),
(2, 3, 'access.role.viewer', 0, 'type.account.standard', 'status.generic.pending'),
(3, 4, 'access.role.curator', 0, 'type.account.standard', 'status.generic.deleted');
