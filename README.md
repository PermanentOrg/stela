...
| LEGACY_BACKEND_CREDIT_STORAGE_SECRET | none                                                      | Can be found in `back-end`'s library/base/constants/base.constants.php, where it's called `MOBILE_ENDPOINT_SECRET`                                                                                                  |
...
| AWS_ENDPOINT_URL                     | http://localstack:4566                                    | Used to point certain cloud services at local copies in the local environments. Do not set in non-local.                                                                                                            |
| LOW_PRIORITY_TOPIC_ARN               | test                                                      | Doesn't need to be set to a real ARN unless your work touches it specifically                                                                                                                                       |
| EVENT_TOPIC_ARN                      | arn:aws:sns:us-west-2:000000000000:Local*Events*<DevName> | Replace <DevName> with your first name (capitalized)                                                                                                                                                                |
